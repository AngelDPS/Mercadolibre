...
if __name__ == "__main__":
    ...
    if getenv("AWS_EXECUTION_ENV") is None:
        ...
        environ["SQSERROR_URL"] = (
            "https://sqs.us-east-2.amazonaws.com/276507440195/"
            "TestMeliErrorQueue.fifo"
        )
    ...
    evento = {"Records": [
        {
            ...
            "eventSourceARN": (
                "arn:aws:dynamodb:us-east-2:276507440195:table/"
                "generico2022-db/stream/2023-07-12T14:33:20.801"
            )
        }
    ]}
